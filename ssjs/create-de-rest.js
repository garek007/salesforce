...
var expectedReferer = "someurl.com";
...
var standardFields = Platform.Request.GetQueryStringParameter("standardFields");//integer, a count of standard headers from main landing
...
switch(mid){
    case "123456": var categoryId = 545; break;//Admin BU
    case "5478": var categoryId = 435; break;//Advanced BU
    case "547987": var categoryId = 345; break;//Standard BU
    case "45872": var categoryId = 34535; break;//Office of Sec BU
    default: var categoryId = 345345;
}
...
try{   
    ...
    if( refURL.indexOf(expectedReferer) > 0 ){
        ...
        if(resp.id){
            response.message = "Data extension was created. Has more headers: "+hasMoreHeaders;
